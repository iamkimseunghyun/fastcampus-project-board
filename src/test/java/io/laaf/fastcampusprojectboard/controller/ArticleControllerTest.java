...
import io.laaf.fastcampusprojectboard.config.TestSecurityConfig;
import io.laaf.fastcampusprojectboard.domain.constant.FormStatus;
import io.laaf.fastcampusprojectboard.domain.constant.SearchType;
import io.laaf.fastcampusprojectboard.dto.ArticleDto;
import io.laaf.fastcampusprojectboard.dto.ArticleWithCommentsDto;
import io.laaf.fastcampusprojectboard.dto.UserAccountDto;
import io.laaf.fastcampusprojectboard.dto.request.ArticleRequest;
import io.laaf.fastcampusprojectboard.dto.response.ArticleResponse;
import io.laaf.fastcampusprojectboard.service.ArticleService;
import io.laaf.fastcampusprojectboard.service.PaginationService;
import io.laaf.fastcampusprojectboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @WithUserDetails(value = "kakaTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    @DisplayName("[view][POST] 게시글 삭제 - 정상 호출")
    @Test
    void givenArticleIdToDelete_whenRequesting_thenDeletesArticle() throws Exception {
        // Given
        long articleId = 1L;
        String userId = "kakaTest";
